...
event_type_mapping = {
    ...
    "TSTM WIND": "THUNDERSTORM", "TSTM WND DMG": "THUNDERSTORM",
    "TSTM WND GST": "THUNDERSTORM", "MARINE TSTM WIND": "THUNDERSTORM"
}
...
for num_epochs in range(1, 11):
    ...
    with open(f'llama3_lora_results_{num_epochs}_epoch3_8s.txt', 'w') as f:
        f.write(f"Evaluation Results for {num_epochs} epochs:\n")
